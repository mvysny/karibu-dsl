...
/**
 * Finds a VISIBLE component in the current UI which matches given [block]. This component and all of its descendants are searched.
 * @return the only matching component, never null.
 * @throws IllegalArgumentException if no component matched, or if more than one component matches.
 */
...
/**
 * Finds a VISIBLE component in the current UI of given [clazz] which matches given [block]. This component and all of its descendants are searched.
 * @return the only matching component, never null.
 * @throws IllegalArgumentException if no component matched, or if more than one component matches.
 */
 ...
 * @param text the [com.vaadin.flow.dom.Element.getText]
...
/**
 * Finds a list of VISIBLE components of given [clazz] which matches [block]. The whole [UI.getCurrent] is searched.
 * @return the list of matching components, may be empty.
 */
