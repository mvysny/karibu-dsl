...
class AllTest : DynaTest({
    ...
    test("vaadin version 2") {
        ...
        val expectedVaadinVersion: SemanticVersion = SemanticVersion.fromString(gradleProps["vaadin20_version"] as String)
        expect(expectedVaadinVersion) { VaadinMeta.fullVersion }
    }
